      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-6">
        <div className="text-center mb-6">
          <label
            ...
            className="flex cursor-pointer items-center justify-center gap-2 rounded bg-[#014064] py-1 px-2 text-sm font-medium text-white hover:bg-opacity-90 xsm:px-4" // Changed background color to #014064
          >
            <input
              type="file"
              name="reportUpload"
