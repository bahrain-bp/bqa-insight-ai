export function createComparePrompt(instituteName: string, metric: string, governorate: boolean = false): string {
    return `
        ...
        Input: How did ${instituteName} do in terms of ${metric}?
    `;
}
...
export function createAnalyzeSchoolPrompt(school: string): string {
    ...
    Input: How did ${school} perform overall?
    Output:
    The performance of ${school} in overall is as follows:
...
export function createCompareSchoolsPrompt(instituteNames?: string, governorate: boolean = false) {
    ...
    Input: ${question}?
    Output:
    The performance of ${instituteNames} is as follows:
...
export function createAnalyzeUniversityPrompt(programme: string, university: string) {
    ...
    Input: How is the ${programme} in ${university}?          
    Output:
    The ${programme} in ${university} has been judged as ....
    Key Strengths:
...
export function createCompareUniversityPrompt(programme: string, institutes: string) {
    const prompt = `
        ...
        Input: Compare between the Bachelor of ${programme} programme offered by ${institutes}?          
        Output:
        Introducion:
...
export function createAnalyzeVocationalTrainingCenter(instituiteName: string) {
    ...
    Output:
        ...
        Input: How did ${instituiteName} do overall?
        Output:
        The performance of ${instituiteName} is as follows:
...
export function createCompareVocationalTrainingCenter(instituiteNames: string) {
    ...
    well-being programs and promoting leadership development among educators.

    Input: How did ${instituiteNames} do overall?
    Output:
    The performance of ${instituiteNames} is as follows:
